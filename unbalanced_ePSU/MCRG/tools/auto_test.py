...
if __name__ =="__main__":
    ...
    parser = argparse.ArgumentParser(description='Run the protocol with specific configurations.')
    parser.add_argument('-nn', type=int, default=12, help='logarithm of set size (default 12)')
